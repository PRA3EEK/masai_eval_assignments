...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> mailNotFoundExceptionHandler(MailNotFoundException mnfe, WebRequest wr)
	{
		ErrorDetails er = new ErrorDetails(mnfe, mnfe.getMessage(), wr.getDescription(false), LocalDateTime.now());
	return new ResponseEntity<ErrorDetails>(er, HttpStatus.BAD_REQUEST);	
	}
